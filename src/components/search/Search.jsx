...
const Search = () => {
  ...
  const url =
    `https://api.spoonacular.com/recipes/complexSearch?query=${decoded}` +
  ...
  if (recipes) {
    const onPageChange = (page) => {
      const p = page < 1 || page > Math.ceil(recipes.totalResults / numberPerPage) ? 1 : page;
