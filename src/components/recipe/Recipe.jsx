...
const Recipe = () => {
  ...
  const {
    ...
    error,
    data: recipe
  } = useFetch(`https://api.spoonacular.com/recipes/${id}/information?includeNutrition=false`);
    ...
    content = (
      <div className="section__container">
        <div className="section-main__container">
          <RecipeHeader title={recipe.title} image={recipe.image} summary={recipe.summary} />
          {width <= 904 ? (
